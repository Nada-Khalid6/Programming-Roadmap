...
def show_roadmap(track_id):
    ...
    for idx, step in enumerate(roadmap):
        with st.container(border=True):
            ...
            with col2:
                # قراءة حالة الإنجاز من ملف التقدم
    ...
    # إظهار نسبة التقدم في نهاية المسار
    if roadmap:
